...
```bash
python3 .shared/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 .shared/scripts/search.py "<keyword>" --stack html-tailwind
```
...
python3 .shared/scripts/search.py "beauty spa wellness service" --domain product

# 2. Search style (based on industry: beauty, elegant)
python3 .shared/scripts/search.py "elegant minimal soft" --domain style

# 3. Search typography
python3 .shared/scripts/search.py "elegant luxury" --domain typography

# 4. Search color palette
python3 .shared/scripts/search.py "beauty spa wellness" --domain color

# 5. Search landing page structure
python3 .shared/scripts/search.py "hero-centric social-proof" --domain landing

# 6. Search UX guidelines
python3 .shared/scripts/search.py "animation" --domain ux
python3 .shared/scripts/search.py "accessibility" --domain ux

# 7. Search stack guidelines (default: html-tailwind)
python3 .shared/scripts/search.py "layout responsive" --stack html-tailwind
```
